...
# %% Manual generation loop (Educational replication)

torch.set_printoptions(sci_mode=False, precision=3, linewidth=200)

INFO = True  # educational ``print``s from ``forward_qwen35_like_hf`` / ``language_model_forward_layer_by_layer``
...
def forward_qwen35_like_hf(
    m: Qwen3_5ForConditionalGeneration,
    *,
